// g++ -o gstreamer_opengl_local gstreamer_opengl_local.cpp `pkg-config --cflags --libs glfw3 gstreamer-1.0 gstreamer-app-1.0` -lGLESv2
...
int main() {
    ...
    app.window = glfwCreateWindow(800, 600, "OpenGL ES GStreamer Local Video Test", NULL, NULL);
    if (!app.window) {
