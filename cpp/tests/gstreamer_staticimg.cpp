...
void load_static_image(AppData* app, const std::string& image_path) {
    ...
    BYTE* data = FreeImage_GetBits(image32bit);
    ...
    update_texture(app->tex_local, data, width, height);
...
int main() {
    ...
    init_gstreamer(&app);
    load_static_image(&app, "../../assets/test.jpeg");
